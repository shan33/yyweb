...
var specificInfo = {
    ...
    house: {
        ...
        coords: [[87,291,'吊脚楼', '<h4>多依山就势而建，呈虎坐形，以“左青龙，右白虎”中间为堂屋，左右两边称为饶间，作居住、做饭之用。</h4>\
    ...
    map: {
        info1: house,
        pic: [],
        coords: [[87,291,'渝东南', '<h4>渝东南位于武陵山的重庆市渝东南地区的酉秀黔彭石，是中国西部四川盆地东南部大娄山和武陵山两大山系交汇的盆缘山地，与渝鄂湘黔四省市结合相连，是重庆唯一集中连片、也是全国为数不多的以土家族和苗族为主的少数民族聚居区。</h4>\
                <h4>渝东南旅游资源丰富，名胜古迹众多。以秀丽的自然山水、独特的历史文化、浓郁的民族风情，逐渐发展成为全国知名的旅游热点地区。</h4>']]
    },
    work: {
        info1: work,
        pic: ['work1', 'work2', 'work3', 'work4'],
        coords: [[568,205, '工作', '犁，用于田地耕地所用']]

    },
    dance: {
        info1: dance,
        pic: ['dance2', 'dance3', 'dance5', 'dance6','dance7','dance8'],
        coords: [[447,361,'摆手舞', '<h4>摆手舞其身体动作主要取材于生产劳动、日常生活和战斗。有“单摆”、“双摆”、“回旋摆”等。在长期发展变化，在各地不完全相同，但其基本特点却是一致的，即顺拐、屈膝、颤动、下沉</h4>\
    ...
    marry: {
        ...
        coords: [[433,332,'婚礼庆祝','结婚时长辈所穿红色衣服'], 
                    [565,394, '礼物', '亲属会送上一些自己定制的结婚物品，通常为红色的棉被']]
    ...
    music: {
        ...
        coords: [[207,263,'木叶' ,'<h4>优良的树种，通常采用桔、柚、杨、枫、冬青等无毒的树叶，叶片的结构匀称，正、背两面都应平整光滑，以柔韧适度、不老不嫩的叶子为佳。</h4>\
    ...
    boy: {
        ...
        pic: [],
        coords: [[598,245,'头包','头包青丝帕或青布，白布帕2．3至3米，包成人字形。'],
                    [10,10,'衣服','老年男子常穿无领满襟短衣，捆腰带，压素色布条“琵琶襟”服，在短衣外面套黑布单褂，俗称“鸦鹊褂”。青年人多穿对襟衣，正中钉上七对、九对、十一对不等量的扣子，领高，袖小而长，袖口滚边。'],
                    [20,20,'裤子','男裤是男子服饰的杰出代表。裤子不分老青壮，皆大脚大腰，一般为青布、蓝布作裤腿，缝上白布裤腰。']]
    },                    
    girl:{
        ...
        pic: ['woman1'],
        coords: [[12,12,'衣服','无领满襟衣。衣向左开襟。从上领到下摆到衣裙脚绣有一寸五宽的花边，衣袖各有一大二小三条花边，大花边一寸五宽，小花边有手指宽。'],
                    [20,20,'妈裙','胸前外套围裙，俗称“妈裙”，围裙上为半圆形，下为三角形，从上半圆形及下脚也有一圈花边，宽约一寸。围裙胸前绣有花约五寸见方，围带即花带均为五彩丝线织成，一般二尺长，两头分别留有三寸未织的花缓']]
    },
    communicate: {
        info1: lang,
        pic: [],
